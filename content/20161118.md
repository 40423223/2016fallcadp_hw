...
<img src="./../data/40423223-2.png" width="800" />

<p>首先利用 Brython, 讀取 data 目錄中的 40423223.csv 座標檔案, 然後以 splitlines() 及 split() 取出各點的 x 座標與 y 座標後, 將點連成路徑曲線如下:</p>
<!-- 導入 Brython 標準程式庫 -->
...
fourbar_data = open("./../data/40423223.csv").read()
